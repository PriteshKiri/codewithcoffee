...
export default function WorkPage() {
  return (
    ...
    <li>Hosted monthly community calls on ToolJet&#39;s <Link href="https://www.youtube.com/@tooljet" target="_blank" rel="noopener noreferrer">YouTube channel</Link>, building internal apps and AI Agents.</li>
